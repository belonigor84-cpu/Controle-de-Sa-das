    ...
    <script>
        ...
        function saveTable() {
            ...
            const rows = Array.from(tableBody.children).map(row => {
                ...
                return {
                    ...
                    alarmPlayed: timerButton ? timerButton.dataset.alarmPlayed || 'false' : 'false',
                    timerId: null
                };
            });
        ...
        function addRow(rowNumber, data = {}) {
            ...
            if (data.running === 'true') {
                ...
                timerButton.dataset.alarmPlayed = data.alarmPlayed || 'false';
        ...
        function startTimer(button) {
            ...
            if (button.dataset.clicks >= 2) {
                ...
                if (document.body.classList.contains('professor-mode')) {
                    ...
                    button.dataset.clicks = '0'; // Reseta o contador
                    button.dataset.seconds = '0';
                    button.dataset.minutes = '0';
                    button.dataset.alarmPlayed = 'false';
                    saveTable();
                }
                return;
            }
            ...
            button.dataset.timerId = setInterval(() => {
                ...
                if (minutes >= 20 && button.dataset.alarmPlayed !== 'true') {
                    const alarm = document.getElementById('alarmSound');
                    alarm.currentTime = 0;
                    alarm.play();
                    button.dataset.alarmPlayed = 'true';
                }
